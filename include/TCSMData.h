...
public:
  ...
  inline vector<Short_t> GetHorizontal_Wave(const unsigned int &i)	const {return fCSM_StripHorizontal_Wave.at(i);}		//!
  ...
  inline vector<Short_t> GetVertical_Wave(const unsigned int &i)	const {return fCSM_StripVertical_Wave.at(i);}			//!
