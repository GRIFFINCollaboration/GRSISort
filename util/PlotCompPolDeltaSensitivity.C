...
void PlotCompPolDeltaSensitivity(){





  printf("The Polarization is %f\n",PolarizationCalculation());
...
pada->SetTopMargin(0.03); padb->SetTopMargin(0.03);
pada->SetBottomMargin(0.2); padb->SetBottomMargin(0.2);
pada->SetLeftMargin(0.16); padb->SetLeftMargin(0.16);
pada->SetRightMargin(0.05); padb->SetRightMargin(0.05);
//~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~PANEL A~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
//~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
c1->cd(1);
...
double PolarizationCalculation(){
  ...
  */
  ...
  for(int loop = 0; loop < 4; loop++){
    ...
    //std::cout<<"K1 = "<<Kcoefficents( MuValues[loop], L2, L2 )<<"\tK2 = "<<Kcoefficents( MuValues[loop], L2, L2+1 )<<"\tK3 = "<<Kcoefficents( MuValues[loop], L2 + 1, L2 + 1 )<<std::endl;
    //std::cout<<"A["<<loop<<"] = "<<A[loop]<<std::endl;
    //std::cout<<"Ap["<<loop<<"] = "<<Ap[loop]<<std::endl;
    //std::cout<<"B["<<loop<<"] = "<<B[loop]<<std::endl;
  }
  
  double P = PlusOrMinus * ( Pnum / Pdenom );
  //std::cout<<"\nThe Polarization at "<<theta<<"deg is calculated with the given F coefficients to be: "<<P<<std::endl;
  return P;
}
