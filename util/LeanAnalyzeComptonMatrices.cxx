...
TList* ComptonPol(TFile* f, TStopwatch* w)
{
  ...
  TH2D* XiHist2D_DetDet      = (TH2D*)f->Get("XiHist2D_DetDetCoincidenceTheta"); list->Add(XiHist2D_DetDet);
  TH2D* XiHist2D_CryCry      = (TH2D*)f->Get("XiHist2D_CryCryCoincidenceTheta"); list->Add(XiHist2D_CryCry);  

  TH2D* XiHist2DGeo_DetDet = (TH2D*)f->Get("XiHist2D_DetDetCoincidenceTheta_Geo"); list->Add(XiHist2DGeo_DetDet);
  TH2D* XiHist2DGeo_CryCry = (TH2D*)f->Get("XiHist2D_CryCryCoincidenceTheta_Geo"); list->Add(XiHist2DGeo_CryCry);
  
  TH2D* XiHist2DNonCo_DetDet = (TH2D*)f->Get("XiHist2D_DetDetCoincidenceTheta_NonCo"); list->Add(XiHist2DNonCo_DetDet);
  TH2D* XiHist2DNonCo_CryCry = (TH2D*)f->Get("XiHist2D_CryCryCoincidenceTheta_NonCo"); list->Add(XiHist2DNonCo_CryCry);
  ...
  AsymmetryX.clear(); AsymmetryX.clear(); AsymmetryY.clear(); AsymmetryYerr.clear();
