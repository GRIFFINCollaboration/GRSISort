...
// g++ main.cxx TFragmentSelector.cxx TFragmentSelectorDict.cxx -I ../GRSISort/include -L ../libraries `root-config
// --cflags --glibs` -lProof -lGRSIFormat -o runme.exe
...
int main(int argc, char** argv)
{
   ...
   for(int x = 1; x < argc; x++) chain->Add(argv[x]);
