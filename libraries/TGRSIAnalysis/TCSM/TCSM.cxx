...
////Builds the CSM Hits directly from the TFragment. Basically, loops through the data for an event and sets observables. 
////This is done for both CSM and it's suppressors.
//	if(!frag || !mnemonic)
//      return;
//
//   Clear("");
...
//            printf("Warning, TCSM::SetWave() set, but data waveform size is zero!\n");
//         }
