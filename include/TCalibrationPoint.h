...
class TCalibrationPoint : public TObject {
 public: 
   TCalibrationPoint();
   TCalibrationPoint(const Double_t &centroid, const Double_t &area, const Double_t &dcentroid=0.0, const Double_t &dArea=0.0);
   virtual ~TCalibrationPoint(); 

   TCalibrationPoint(const TCalibrationPoint &copy);
