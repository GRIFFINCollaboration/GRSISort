...
Double_t TPeak::fitFunction(Double_t *dim, Double_t *par){
...
int TPeak::FitPeak(Int_t limit1, Int_t limit2, Double_t centroid) {} // termination version
...
*/
Bool_t TPeak::FitPhotoPeak(Double_t *par, TH1 *h, Float_t &area, Float_t &darea, Double_t *energy, Bool_t verbosity){
