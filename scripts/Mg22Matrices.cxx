...
TList *Mg22Matrices(TTree* tree, TPPG* ppg, TGRSIRunInfo* runInfo, long maxEntries = 0, TStopwatch* w = nullptr) {
   ...
   auto* gglongmatrixT = new THnSparseF("gglongmatrixT","#gamma-#gamma matrix sorted in E",3,sparsebins,sparselow,sparsehigh); list->Add(gglongmatrixT);
   auto* bgTDiffgE = new TH2D("bgTDiffgE","#beta-#gamma Time Difference vs. #gamma E",2000,0.,2000., 400,-100.,300.); list->Add(bgTDiffgE);
   ...
   auto* gammaSingles = new TH1D("gammaSingles","#gamma singles;energy[keV]",nofBins*4, low, high); list->Add(gammaSingles);
