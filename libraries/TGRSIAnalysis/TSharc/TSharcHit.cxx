...
void TSharcHit::Copy(TObject& rhs) const
{
   ...
   static_cast<const TGRSIDetectorHit&>(fBackHit).Copy(static_cast<TObject&>(dynamic_cast<TSharcHit&>(rhs).fBackHit));
   static_cast<const TGRSIDetectorHit&>(fPadHit).Copy(static_cast<TObject&>(dynamic_cast<TSharcHit&>(rhs).fPadHit));
