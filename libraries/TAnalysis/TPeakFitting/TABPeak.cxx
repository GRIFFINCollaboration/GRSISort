...
Double_t TABPeak::OneHitPeakFunction(Double_t* dim, Double_t* par)   // NOLINT(readability-non-const-parameter)
{
...
Double_t TABPeak::TwoHitPeakFunction(Double_t* dim, Double_t* par)   // NOLINT(readability-non-const-parameter)
{
   Double_t x          = dim[0];   // channel number used for fitting
   Double_t height     = par[0];   // height of photopeak
   Double_t centroid   = par[1];   // Peak Centroid of non skew gaus
