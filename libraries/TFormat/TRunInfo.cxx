...
void TRunInfo::Add(TRunInfo* runinfo, bool verbose)
{
   ...
   if(verbose) { std::cout << std::endl << "adding run " << runinfo->fRunNumber << ", sub run " << runinfo->fSubRunNumber << " (" << runinfo << ") to run " << fRunNumber << ", sub run " << fSubRunNumber << " (" << this << ")" << std::endl; }
