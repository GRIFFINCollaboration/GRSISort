...
void TPeak::CheckArea(Double_t int_low, Double_t int_high) {
   ...
   if (std::abs(peakarea-fArea)<(fDArea+peakerr)) printf(DGREEN "Areas are consistent.\n" RESET_COLOR);
   else if (std::abs(peakarea-fArea)<2*(fDArea+peakerr)) printf(DYELLOW "Areas are consistent within 2 sigma.\n" RESET_COLOR);
