...
ClassImp(TWaveformAnalyzer)

TWaveformAnalyzer::TWaveformAnalyzer(){
	N=0;
	wpar=new WaveFormPar;
	LARGECHISQ=1E111;
}
TWaveformAnalyzer::TWaveformAnalyzer(TFragment* fragment){
	frag=fragment;
	N=frag->wavebuffer.size();
	wpar=new WaveFormPar;
	LARGECHISQ=1E111;
}
...
// Very efficient apparently, written by Kris S, but I haven't looked at how it works
// Solve the currently stored n dimentional linear eqaution
int TWaveformAnalyzer::solve_lin_eq(){
...
long double  TWaveformAnalyzer::determinant(int m){
	int j,i;
	long double s;
...
int TWaveformAnalyzer::fit_smooth_parabola(int low, int high, double x0, ParPar* pp){
	int i,ndf,k;
	double chisq;
	double x;
...
/*================================================================*/
int TWaveformAnalyzer::fit_parabola(int low, int high,ParPar* pp){
  int i,ndf;
  double chisq;
  memset(pp,0,sizeof(ParPar));
  lineq_dim=3;
...
/*================================================================*/
int TWaveformAnalyzer::fit_line(int low, int high,LinePar* lp){
  int i,ndf;
  double chisq;
...
double  TWaveformAnalyzer::get_linear_T0(){
  LinePar lp,lpl;
  int k,kmin;
  double chit,chitmin;
  double b,c,t;
...
/*================================================================*/
double  TWaveformAnalyzer::get_smooth_T0()
{
  ParPar pp,ppmin;
  int k,kmin;
  double chit,chitmin;
...
/*================================================================*/
double TWaveformAnalyzer::get_parabolic_T0(){
...
double  TWaveformAnalyzer::fit_newT0(){
...
void TWaveformAnalyzer::get_baseline(){
	wpar->baseline=0.;
...
void TWaveformAnalyzer::get_baseline_fin(){
	wpar->baselinefin=0.;
...
void TWaveformAnalyzer::get_tmax(){
	int i,j,sum;
	int D=FILTER/2;
...
/*===========================================================*/
double TWaveformAnalyzer::get_tfrac(double frac,double fraclow, double frachigh)
{
  int t;
  double f,flow,fhigh;
  int i,imax,imin;
...
/* ==================================================== */
void TWaveformAnalyzer::get_t50(){
  int t;
...
/* ==================================================== */
void TWaveformAnalyzer::get_t90(){
  int t;
...
/*===========================================================*/
void TWaveformAnalyzer::get_t10(){
  int t;
...
/*===========================================================*/
void TWaveformAnalyzer::get_t30(){
  int t;
...
/*======================================================*/
void TWaveformAnalyzer::get_sig2noise(){ if(N==0)return;
...
// void  TWaveformAnalyzer::display_newT0_fit( TApplication* theApp){ if(N==0) return;
// 
...
/*======================================================*/
void TWaveformAnalyzer::print_WavePar()
{
