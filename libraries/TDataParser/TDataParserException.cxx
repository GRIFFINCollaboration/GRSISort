   ...
   : fParserState(state), fFailedWord(failedWord), fMultipleErrors(multipleErrors)
{
   ...
   switch(fParserState) {
   case TDataParser::EDataParserState::kGood: stream << "state is good, no idea what went wrong!" << std::endl; break;
   case TDataParser::EDataParserState::kBadHeader:
      stream << "bad header (either not high nibble 0x8 or an undefined bank)" << std::endl;
      break;
   case TDataParser::EDataParserState::kMissingWords: stream << "missing scaler words" << std::endl; break;
   ...
   case TDataParser::EDataParserState::kBadScalerHighTS:
      stream << "bad scaler word with high time stamp bits (either high nibble not 0xe or the 8 LSB don't match the 8 "
             ...
             << std::endl;
      break;
   case TDataParser::EDataParserState::kBadScalerType: stream << "undefined scaler type" << std::endl; break;
   ...
   case TDataParser::EDataParserState::kSecondHeader:
      ...
      break;
   case TDataParser::EDataParserState::kWrongNofWords: stream << "wrong number of words" << std::endl; break;
   ...
   case TDataParser::EDataParserState::kFault:
      ...
      break;
   case TDataParser::EDataParserState::kMissingPsd: stream << "missing psd words" << std::endl; break;
   ...
   case TDataParser::EDataParserState::kMissingCharge:
      ...
      break;
   case TDataParser::EDataParserState::kBadBank: stream << "undefined bank" << std::endl; break;
   case TDataParser::EDataParserState::kBadModuleType: stream << "undefined module type" << std::endl; break;
