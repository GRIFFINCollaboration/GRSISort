...
void TEfficiencyGraph::BuildGraph() {
	...
	for(auto it : fCompareMap){
		...
		SetPointError(point_to_add,src_energy_err,meas_area/src_intensity*TMath::Sqrt(TMath::Power(meas_area_err/meas_area,2.) + TMath::Power(src_intensity_err/src_intensity,2.0)));
	}
}
