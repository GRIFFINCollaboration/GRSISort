...
//Usage is: tac_calibration /path/to/datafile.root

//Takes an AnalysisTree, searches for anti-coincidences TAC-LaBr (so we are sure we only have the TAC-calibrator and not LaBr-LaBr timing) and performs a linear fit to the peaks it finds. The output is a *.cal file with the TAC calibrated.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   for(int j=0; j<=7; j++){
     ...
     if(nfound>number_of_peaks){
       std::cout<<"WARNING!!! Tspectrum found "<<(nfound-number_of_peaks)<<" too many peaks " <<std::endl;//Warning for bad peak found, results should be inspected
