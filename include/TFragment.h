...
public:
   ...
   {
      std::cerr << "Error, " << __PRETTY_FUNCTION__ << " called, TFragment shouldn't have a number of filters." << std::endl;   // NOLINT(cppcoreguidelines-pro-bounds-array-to-pointer-decay)
   }
...
private:
   ...
   /// \cond CLASSIMP
   ClassDefOverride(TFragment, 8)   // NOLINT(readability-else-after-return)
   /// \endcond
};
/*! @} */
#endif   // TFRAGMENT_H
