...
public:
   ...
   TGraph* KinVsTheta(double thmin = 0.0, double thmax = 180.0, int part = 2, bool Frame_Lab = true,
                      bool Units_keV = true);
   // TSpline3 KinVsThetaSpline(double thmin = 0.0, double thmax = 180.0, int part = 2, bool Frame_Lab = true, bool
   // Units_keV = true) {
   //   static int number =0;
   //   return TSpline3(Form("KinVsTheta_%i",number++),KinVsTheta(thmin,thmax,part,Frame_Lab,Units_keV));
   //}
