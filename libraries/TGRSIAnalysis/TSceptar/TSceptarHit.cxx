...
Int_t TSceptarHit::CalculateCfd(double attenuation, int delay, int halfsmoothingwindow, int interpolationSteps) {
...
Int_t TSceptarHit::CalculateCfdAndMonitor(double attenuation, int delay, int halfsmoothingwindow, int interpolationSteps, std::vector<Short_t>& monitor) {
   //Used when calculating the CFD from the waveform
