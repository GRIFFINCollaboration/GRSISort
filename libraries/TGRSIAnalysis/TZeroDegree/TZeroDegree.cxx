...
void TZeroDegree::AddFragment(TVirtualFragment* frag, MNEMONIC* mnemonic) {
   ///Builds the ZDS Hits directly from the TVirtualFragment. Basically, loops through the data for an event and sets observables.
